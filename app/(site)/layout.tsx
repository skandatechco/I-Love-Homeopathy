            ...
            <footer className="site-footer">
              <Container>
                <div className="footer-top">
                  ...
                  <div className="footer-links">
                    <div className="footer-col">
                      <h5>Learn</h5>
                      <ul>
                        <li><a href="/en/articles/remedy-of-the-day">Remedy of the Day</a></li>
                        <li><a href="/en/remedies">Materia Medica</a></li>
                        <li><a href="/en/articles/remedy-quiz">Remedy Quiz</a></li>
                        <li><a href="/en/articles/clinical-cases">Clinical Cases</a></li>
                      </ul>
                    </div>
                    <div className="footer-col">
                      <h5>Explore</h5>
                      <ul>
                        <li><a href="/en/articles/philosophy">Philosophy</a></li>
                        <li><a href="/en/research">Research</a></li>
                        <li><a href="/en/articles/remedy-resonance">Remedy Resonance</a></li>
                        <li><a href="/en/articles/wellness">Wellness</a></li>
                      </ul>
                    </div>
                    <div className="footer-col">
                      <h5>History</h5>
                      <ul>
                        <li><a href="/en/articles/history">Great Homeopaths</a></li>
                        <li><a href="/en/articles/history">Homeopathic Hospitals</a></li>
                        <li><a href="/en/articles/book-reviews">Book Reviews</a></li>
                      </ul>
                    </div>
                    <div className="footer-col">
                      <h5>Connect</h5>
                ...
                <div className="footer-bottom">
                  <span>© 2026 I Love Homeopathy. All rights reserved.</span>
                  <span>
