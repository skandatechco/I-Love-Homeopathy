...
function displayExcerpt(
  ...
  fallback = "Read more from the ILH editorial archive."
) {
  if (!article) return fallback;
  const excerpt = cleanText(article.excerpt);
  if (!excerpt) return fallback;
...
function SectionBadge({ article }: { article: ArticleDoc }) {
  const colour = getSectionColour(article.section);
  return (
    <span
      className="kicker inline-flex items-center gap-2 rounded-full px-2 py-1"
...
function SectionHeader({
  ...
  return (
    <div
      ...
      style={{ borderBottom: `3px solid ${colour.border}` }}
    >
      <h2 style={{ color: colour.text }}>{title}</h2>
...
export default async function HomePage({
  ...
  const quizFeature =
    pickStories(articles, 1, (article) => article.section === "remedy-quiz")[0] ||
    null;
  const philosophy = pickStories(
    articles,
    3,
    (article) => article.section === "philosophy"
  );
  const history = pickStories(
    articles,
    4,
    (article) => article.section === "history"
  );
  const resonance = pickStories(
    articles,
    4,
    (article) => article.section === "remedy-resonance"
  );
  const wellness = pickStories(
    articles,
    3,
      ...
      <div className="homepage-reference">
        <div className="hero-section">
          <div className="hero-primary">
            <div className="hero-img-wrap">
              <PlaceholderGraphic
                background="#0d3d4f"
                title="Lachesis"
                subtitle="Materia Medica"
              />
              <div className="hero-overlay">
                <SectionBadge article={featured ?? articles[0]} />
                <h1 className="hero-title">
                  {displayTitle(
                    featured,
                    "Dynamic Medicine: Why Homeopathy Changes the Very Nature of Healing Itself"
                  )}
                </h1>
                <p className="hero-deck">
                  {displayExcerpt(
                    featured,
                    "A body, heart, mind, and soul approach to medicine — how homeopathy's energetic paradigm is rewriting what it means to cure a patient, not merely suppress symptoms."
                  )}
                </p>
              </div>
            </div>
            <div className="hero-byline">
              ...
              <span className="dot">·</span>
              <span>{getSectionColour(featured?.section || "philosophy").label}</span>
              <span className="dot">·</span>
          ...
          <div className="hero-sidebar">
            <div
              ...
              style={{ borderBottom: `3px solid ${getSectionColour("remedy-of-the-day").border}` }}
            >
              <h3 style={{ color: getSectionColour("remedy-of-the-day").text }}>
                Remedy of the Day
              </h3>
            </div>
            <div className="remedy-day-card" id="remedy-of-the-day">
              ...
              <div className="remedy-name">
                {displayTitle(remedyOfDay, "Causticum")}
              </div>
              <div className="remedy-latin">
                {cleanText(remedyOfDay?.author, "Causticum Hahnemanni")}
              </div>
              <div className="remedy-keynote">
                {displayExcerpt(
                  remedyOfDay,
                  '"The remedy for chronic ailments that come on slowly, with progressive weakness and paralysis."'
                )}
              </div>
              <a className="remedy-link" href={storyHref(contentLang, remedyOfDay)}>
                Explore full materia medica →
              </a>
            </div>
            ...
            <div
              ...
              style={{
                marginTop: 8,
                borderBottom: `3px solid ${getSectionColour(sidebarStories[0]?.section || "book-reviews").border}`,
              }}
            >
              <h3 style={{ color: getSectionColour(sidebarStories[0]?.section || "book-reviews").text }}>
                Most Read This Week
              </h3>
            </div>
            <div className="sidebar-list">
              {sidebarStories.map((story, index) => {
                const colour = getSectionColour(story.section);
                return (
                  <a
                    className="sidebar-article"
                    key={story.slug}
                    href={storyHref(contentLang, story)}
                    style={{ borderLeft: `3px solid ${colour.border}`, paddingLeft: 10 }}
                  >
        ...
        <section className="section-module" id="clinical-cases">
          <SectionHeader
            ...
            href={`/${contentLang}/articles/clinical-cases`}
            linkLabel="All Cases →"
          />
          <div className="grid-feature">
            <a
              className="feature-card"
              href={storyHref(contentLang, clinicalCases[0])}
              style={{
                borderLeft: `3px solid ${getSectionColour(clinicalCases[0].section).border}`,
                paddingLeft: 10,
              }}
            >
              <div className="feature-card-img">
                <PlaceholderGraphic
                  background="#e0d8c4"
                  title="?"
                  subtitle="Clinical Showcase"
                />
              </div>
              <SectionBadge article={clinicalCases[0]} />
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {clinicalCases.slice(1, 4).map((story) => (
                <a
                  ...
                  href={storyHref(contentLang, story)}
                  style={{
                    borderLeft: `3px solid ${getSectionColour(story.section).border}`,
                    paddingLeft: 10,
                  }}
                >
                  <SectionBadge article={story} />
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {quizFeature ? (
                <a
                  ...
                  style={{
                    borderLeft: `3px solid ${getSectionColour(quizFeature.section).border}`,
                    paddingLeft: 10,
                  }}
                >
                  ...
                  <SectionBadge article={quizFeature} />
        ...
        <div className="quiz-module" id="quiz-module">
          <div className="quiz-inner">
            <div className="quiz-left">
              <span
                className="section-label inline-flex rounded-full px-2 py-1"
                style={{
                  background: getSectionColour("remedy-quiz").bg,
                  color: getSectionColour("remedy-quiz").text,
                }}
              >
                Remedy Quiz · What&apos;s the Remedy?
              </span>
              <h2 className="quiz-title">Test Your Materia Medica</h2>
              <div className="quiz-question">
                A 6-month-old baby girl. Fair, plump, and pleasant. Gets fever
                after a head bath. Worse from warmth, better in open air.
                Thirstless despite the fever. No two stools alike. What is the
                remedy?
              </div>
            ...
            <div className="quiz-right">
              ...
              <p>
                Our daily quiz sharpens the prescribing instinct. From classic
                keynotes to full case studies — tested by homeopaths worldwide.
              </p>
        ...
        <section className="section-module" id="philosophy">
          <SectionHeader
            ...
            section="philosophy"
            href={`/${contentLang}/articles/philosophy`}
            ...
            {philosophy.map((story, index) => (
              ...
              >
                <div className="article-card-img">
                  <PlaceholderGraphic
                    background={
                      index === 0 ? "#1a3520" : index === 1 ? "#2d5a3d" : "#0a1f2e"
                    }
        ...
        <div className="philosophy-band">
          <div className="pull-quote-wrap">
            <p className="pull-quote">
              Homeopathy is revolutionary because it changes the very nature and
              purpose of medicine itself. The goal is not just to relieve pain —
              it is to restore health, and balance, and the full expression of
              the vital force.
            </p>
            <span className="pull-attr">
              Dr. Larry Malerba, MD — Dynamic Medicine
            </span>
          </div>
        </div>
        ...
        <section className="section-module" id="history">
          <SectionHeader
            ...
            section="history"
            href={`/${contentLang}/articles/history`}
            linkLabel="Archives →"
          />
          <div className="history-grid">
            <div className="history-portrait">
              ...
              <p className="history-portrait-cap">
                Dr. Sidney Robinson (1895, Australia) — Owner of the Homeopathic
                Dispensary, Myer&apos;s Place, Melbourne
              </p>
            </div>
            <div className="history-content">
              <span
                className="kicker inline-flex rounded-full px-2 py-1"
                style={{
                  background: getSectionColour("history").bg,
                  color: getSectionColour("history").text,
                }}
              >
                Ambassadors of Homeopathy
              </span>
              <h3>
                {displayTitle(
                  history[0],
                  "The Forgotten Pioneers: Homeopathy's Great Hospitals and the Physicians Who Built Them"
                )}
              </h3>
              <p>
                {displayExcerpt(
                  history[0],
                  "Before antibiotics and before the pharmaceutical industry, homeopathic hospitals dotted the cities of the English-speaking world."
                )}
              </p>
              <p>
                {displayExcerpt(
                  history[1],
                  "From the Hahnemann College of Pennsylvania to the Rochester School of Nursing, these institutions trained generations of physicians."
                )}
              </p>
              <a
                className="see-all"
                style={{ color: "var(--gold)", fontSize: 12 }}
                href={storyHref(contentLang, history[0])}
              >
                ...
                {history.slice(1, 4).map((story, index) => (
                  ...
                  >
                    <div className="profile-mini-img">
                      <PlaceholderGraphic
                        background={
                          index === 0 ? "#2d5a3d" : index === 1 ? "#1a3520" : "#4a7c5f"
                        }
                        title={index === 0 ? "P.S.O" : index === 1 ? "EF" : "SC"}
                      />
                    </div>
                    <SectionBadge article={story} />
        ...
        <section className="section-module" id="remedy-resonance">
          <SectionHeader
            ...
            section="remedy-resonance"
            href={`/${contentLang}/articles/remedy-resonance`}
        ...
        <div className="wellness-strip" id="wellness">
          ...
          <div>
            <div
              ...
              style={{
                marginBottom: 16,
                borderBottom: `3px solid ${getSectionColour("wellness").border}`,
              }}
            >
              <h2 style={{ color: getSectionColour("wellness").text }}>
                Living Well
              </h2>
              <a className="see-all" href={`/${contentLang}/articles/wellness`}>
                All Wellness →
              </a>
            </div>
        ...
        <div className="newsletter" id="newsletter">
          ...
          <p>
            One remedy, one case, one insight — delivered to your inbox every
          ...
          <p className="nl-fine">
            Join 28,000 practitioners and students worldwide. Unsubscribe
            anytime.
          </p>
        </div>
      </div>
